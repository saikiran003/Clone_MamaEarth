        ...
        >
          <SwiperSlide>
            <div className={styles.AOT_coverImg1}>
              <img
                src={
                  "https://images.ctfassets.net/66mrrren2unf/4usS7VI6DjrDrBwNpl5ngu/580d570b03cf60849ec9682467b3fce4/Desktop.jpg?q=40"
                }
                alt="mama"
              />
            </div>
          ...
          <SwiperSlide>
            <div className={styles.AOT_coverImg1}>
              <img
                src={
                  "https://images.ctfassets.net/66mrrren2unf/5dElTf4nIm0q7zDEmWgU4j/bcd1ab0f30ea5fef52e00b2436658dcb/Desktop_Henna-Paste-with-CTA.jpg?q=40"
                }
                alt="mama"
              />
            </div>
          ...
          <SwiperSlide>
            <div className={styles.AOT_coverImg1}>
              <img
                src={
                  "https://images.ctfassets.net/66mrrren2unf/4ZxCZpdHR9x7MBSqyxGVg2/b118c0c231fcc43c8531479834cba44f/Desktop.jpg?q=40"
                }
                alt="mama"
              />
            </div>
          ...
          <SwiperSlide>
            <div className={styles.AOT_coverImg1}>
              <img
                src={
                  "https://images.ctfassets.net/66mrrren2unf/2nFAFSa68RorsrU94U5pO9/90708e3f5bd6f312d9911b63e4977a3e/desktop-body-wash.jpg?q=40"
                }
                alt="mama"
              />
            </div>
              ...
              <>
                <SwiperSlide key={item.id}>
                  <div
                    ...
                    className={styles.AOT_productCard1}
                  >
                    <div className={styles.AOT_productImg}>
                      <img src={item.pImg} alt="mama" />
                    </div>
                    <div className={styles.AOT_productName}>
                      <p>{item.name}</p>
                    </div>
                    <div className={styles.AOT_productDesp}>
                      <p>{item.pShortDec}</p>
                    </div>
                    <div className={styles.AOT_productRR}>
                      ...
                      <div className={styles.AOT_productReview}>
                        <div className={styles.AOT_productInnerReview1}>
                          <img
                            src={
                              "https://mamaearth.in/static/mamaearth/verified.svg"
                            }
                            alt="mama"
                          />
                        </div>
                    ...
                    <div className={styles.AOT_productPrice}>
                      <p>₹{item.price}</p>
                    </div>
        ...
        {data.map((el) => {
          return (
            <div
              ...
              key={el.id}
              className={styles.AOT_productCard}
            >
              <div className={styles.AOT_productImg}>
                <img src={el.pImg} alt="mama" />
              </div>
              <div className={styles.AOT_productName}>
                <p>{el.name}</p>
              </div>
