    ...
    <>
        ...
        >
          <SwiperSlide>
            <div className={styles.AOT_coverImg1}>
              <img
                src={
                  "https://images.ctfassets.net/66mrrren2unf/7FIW8yXsliQhjZIitZ5t8H/dfa440905e497c2cd86807a265b40076/_Body-Range-without-CTA_1920-512_.jpg?q=40"
                }
                alt=""
              />
            </div>
      ...
      <div className={styles.AOT_sortFilter}>
        ...
        <div className={styles.AOT_productFilter}>
          ...
          <button onClick={() => handleFilter("Body Lotion")}>
            Body Lotion
          </button>
