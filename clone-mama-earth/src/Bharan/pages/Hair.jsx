    ...
    <>
        ...
        >
          ...
          <SwiperSlide>
            <div className={styles.AOT_coverImg1}>
              <img
                src={
                  "https://images.ctfassets.net/66mrrren2unf/7dEBxXbTzZNpHkQuBGwTUH/a5dbe423c5569360d02ddd8121419c46/Desktop_Henna-Paste-with-CTA.jpg?q=40"
                }
                alt=""
              />
            </div>
          ...
          <SwiperSlide>
            <div className={styles.AOT_coverImg1}>
              <img
                src={
                  "https://images.ctfassets.net/66mrrren2unf/69siw2mSt1EipsLdDWtvgW/a2320eaaecd8c9f18be18273ebfffacd/Onion-Oil_1920-512_.jpg?q=40"
                }
                alt=""
              />
            </div>
                ...
                <SwiperSlide key={item.id}>
                  ...
                  >
                    ...
                    <div
                      ...
                      className={styles.AOT_productDesp}
                    >
                      <p>{item.pShortDec}</p>
                    </div>
      ...
      <div className={styles.AOT_sortFilter}>
        ...
        <div className={styles.AOT_productFilter}>
          ...
          <button onClick={() => handleFilter("Hair conditioner")}>
            Conditioner
          </button>
