...
import styles from "../Bharan/Footer.module.css"
        ...
        <div className={styles.AOT_footer}>
          ...
          <div className={styles.AOT_Div1}>
           ...
           <div className={styles.AOT_inner1_div1}>
                <span><img src={"https://mamaearthp.imgix.net/wysiwyg/mobile-truck.png?auto=format"} alt="" /></span>
               <p>Free Shipping</p>
               <p className={styles.AOT_inner1_div1_p}>On Orders Above Rs.399</p>
            </div>
            <div className={styles.AOT_inner1_divm}></div>
            <div className={styles.AOT_inner1_div2}>
              <span><img src={"https://mamaearthp.imgix.net/wysiwyg/mobile-wallet.png?auto=format"} alt="" /></span>
              <p>COD Available</p>
          ...
          <div className={styles.AOT_Div4}>
            ...
            <div className={styles.AOT_socialDivs}>
                <div>
                 <Link to="https://www.facebook.com/Mamaearthindia/"><i class="fab fa-facebook-f"></i></Link>
                </div>
                <div>
