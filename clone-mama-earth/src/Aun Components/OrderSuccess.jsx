...
const OrderSuccess = ({name,pin,city,state}) => {
  ...
  return (
    <div>
      <div id="container">
        <div><img src="https://cdn.dribbble.com/users/147386/screenshots/5315437/media/64a3a80eb03d6fe459abd7e7c1d889f9.gif"
          className={styles.ordSucc} /></div>
          
        <h2 style={{ color: "red" }}>Payment Successful</h2>
        <h3>Thank you {name} for shopping with us .. !</h3>
        <h3>Your order will be delivered to {city} {pin} {state}</h3>
      </div>
      {/* <Link to="/credit">
        <button
