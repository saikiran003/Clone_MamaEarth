const footer = ()=>{
    ...
    <div class="ApaymentDiv">
        <div>
            <h3>PAYMENT</h3>
        </div>
        <div style="color:rgb(150,202,65); font-size: 14px;">
    ...
    <div class="AcertificatesMainDiv">
        <div class="Acertificates">
    ...
    <div class="AfooterLinks">
         ...
         <div class="AfooterEconomivs">
            <img src="https://mamaearthp.imgix.net/wysiwyg/Best-Brand500x5002x.png?auto=format" alt="">
         </div>
    </div>
    <div class="AfooterLastDIv">
        <h3>SHOW US SOME <i class="fa-solid fa-heart"></i> ON SOCIAL MEDIA</h3>
        <div class="AfooterIcon">
    ...
    <div style="padding: 14px; text-align: center; font-size: 14px; border-bottom: solid #5c5c5c 1px;">
