      ...
      <div style={{ width: "90%", margin: "auto", display: "flex",gap:"5%"}}>
        <div style={{ display: "flex" }}>
          <div style={{ marginLeft: "7%"}}>
            <img src="https://mamaearthp.imgix.net/wysiwyg/dermatology-tested-100x100.png?auto=format&fit=100%2C100&ssl=1" width="70px" height="70px" />
          </div>
          <div>
        ...
        <div style={{ display: "flex" }}>
          <div style={{ marginLeft: "7%"}}>
            <img src="https://mamaearthp.imgix.net/wysiwyg/fda-100x100.jpg?auto=format&fit=100%2C100&ssl=1" width="70px" height="70px" />
          </div>
          <div>
            <h3>FDA Approved</h3>
            <p>
        ...
        <div style={{ display: "flex" }}>
          <div style={{ marginLeft: "7%"}}>
            <img src="https://mamaearthp.imgix.net/wysiwyg/msafe-100x100.jpg?auto=format&fit=100%2C100&ssl=1" width="70px" height="70px" />
          </div>
          <div>
